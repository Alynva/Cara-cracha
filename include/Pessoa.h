...
Pessoa::Pessoa() {
	...
	this->rosto = GeoA::random(1, 3);
	this->cor_do_rosto = GeoA::random(1, 3);
	this->oculos = GeoA::random(1, 3);
	this->cor_do_oculos = GeoA::random(1, 3);
	this->cabelo = GeoA::random(1, 3);
	this->cor_do_cabelo = GeoA::random(1, 3);
	this->barba = GeoA::random(1, 3);
	this->cor_da_barba = this->cor_do_cabelo;
	this->blusa = GeoA::random(1, 3);
	this->cor_da_blusa = GeoA::random(1, 3);
	this->calca = GeoA::random(1, 3);
	this->cor_da_calca = GeoA::random(1, 3);
	this->tenis = GeoA::random(1, 3);
	this->cor_do_tenis = GeoA::random(1, 3);
